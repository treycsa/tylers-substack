#!/usr/bin/env bash
# Auto-generated quickstart for browser-use/browser-use. Edit freely; this file is the published receipt.
set -euo pipefail
git clone --depth 1 https://github.com/browser-use/browser-use repo
cd repo
